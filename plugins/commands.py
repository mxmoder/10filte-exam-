    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            await message.reply_text(
                text=f"<b>Hey {message.from_user.mention}, You are successfully verified !\nNow you have unlimited access for all movies till today midnight.</b>" ,reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('Get File', url=f'https://t.me/{temp.U_NAME}?start=file_{file_id}')]]))
